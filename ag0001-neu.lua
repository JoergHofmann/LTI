...
inventar:
        ...
        RangHeaderUV: 9
        RangSummeUV: 15
        RangSummeVermoegen: 16
        RangHeaderSchulden: 17
        RangSummeSchulden: 22
        RangReinvermoegen: 23
        Vermoegen:
                Anlagevermoegen:
                        -
...
html_vorlage = [[
   ...
   var {{AgId}}_inv_liste = new Array(),
       ...
       {{AgId}}_ZahlElemente = {{ZahlElemente}};


   {{AgId}}_inv_liste[0] = '<div id="{{AgId}}_inv0" data-rang="1" class="list-element" draggable = "true"><span class="bezeichnung">Vermögen</span><span class="menge"></span><span class="zahlenspalte"></span><span class="zahlenspalte"></span><span class="korrektur"></span></div>';
   h = h +{{AgId}}_inv_liste[0];
   {{AgId}}_inv_liste[1] = '<div id="{{AgId}}_inv1" data-rang="2" class="list-element" draggable = "true"><span class="bezeichnung">Anlagevermögen</span><span class="menge"></span><span class="zahlenspalte"></span><span class="zahlenspalte"></span><span class="korrektur"></span></div>';
   h = h +{{AgId}}_inv_liste[1];
   {{AgId}}_inv_liste[2] = '<div id="{{AgId}}_inv2" data-rang="{{RangHeaderUV}}" class="list-element" draggable = "true"><span class="bezeichnung">Umlaufvermögen</span><span class="menge"></span><span class="zahlenspalte"></span><span class="zahlenspalte"></span><span class="korrektur"></span></div>';
   h = h +{{AgId}}_inv_liste[2];
   {{AgId}}_inv_liste[3] = '<div id="{{AgId}}_inv3" data-rang="{{RangHeaderSchulden}}" class="list-element" draggable = "true"><span class="bezeichnung">Schulden</span><span class="menge"></span><span class="zahlenspalte"></span><span class="zahlenspalte"></span><span class="korrektur"></span></div>';
   h = h +{{AgId}}_inv_liste[3];
   {{AgId}}_inv_liste[4] = '<div id="{{AgId}}_inv4" data-rang="{{RangReinvermoegen}}" class="list-element" draggable = "true"><span class="bezeichnung">Reinvermögen</span><span class="menge"> </span><span class="zahlenspalte"> </span><span class="zahlenspalte"><input draggable="true" id="Reinvermoegen" name="Reinvermoegen" class="eingabe" type="text"/></span><span class="korrektur"></span></div>';
   h = h +{{AgId}}_inv_liste[4];
...
{{AgId}}_inv_liste[{{Index}}] = '<div id="{{AgId}}_inv{{Index}}" data-rang="{{Rang}}" class="list-element" draggable = "true">' +
			 ...
			 '</div>';
   h = h +{{AgId}}_inv_liste[{{Index}}];
   {{/inventar}}
   document.getElementById('{{AgId}}_liste').innerHTML = h;
   {{AgId}}MaxElemente = {{AgId}}_inv_liste.length -1;
   ThisForm = document.forms['form_{{AgId}}']
   ...
   ThisForm.elements['neu'].addEventListener('click', function() { neu('{{AgId}}', {{AgId}}_inv_liste)});
   </script>
   </section>
]]
-- **}
...
function main (g) -- {**
    ...
    for i = 1, z, 1 do
        ...
        YamlOutputStr = YamlOutputStr .. '      Index: ' .. i .. '\n'
    ...
    OutputData.ZahlElemente = ZahlElemente + 9
